 ...
 * with the object you want to check, and then call . When a non-serializable
 * object is found, a {@link NotSerializableException} is thrown with a message
 * that shows the trace up to the not- serializable object. The exception is
 * thrown for the first non-serializable instance it encounters, so multiple
 * problems will not be shown.
 * <p>
