...
public class WSwingConsoleInterface implements ConsoleSystemInterface, Runnable, ComponentListener {
	...
	public WSwingConsoleInterface() {
		...
		Dimension initialSize = new Dimension(1208, 1024);
	...
	private static final Color DARKRED_COLOR = new Color(128, 0, 0);
	private static final Color DARKBLUE_COLOR = new Color(0, 0, 200);
	private static final Color DARKGREEN_COLOR = new Color(0, 128, 0);
	private static final Color DARKMAGENTA_COLOR = new Color(128, 0, 128);
	private static final Color TEAL_COLOR = new Color(0, 128, 128);
	private static final Color BROWN_COLOR = new Color(128, 128, 0);
