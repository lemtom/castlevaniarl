...
public class GFXCuts {
	...
	private BufferedImage PRT_DRACULA, PRT_CHRIS, PRT_SOLIEYU, PRT_SOLIEYU_D, PRT_MELDUCK, PRT_CLARA, PRT_MAIDEN,
			PRT_DEATH, PRT_VINDELITH, PRT_CLAW;
	public BufferedImage PRT_M1, PRT_M2, PRT_M3, PRT_M4, PRT_M5, PRT_M6, PRT_F1, PRT_F2, PRT_F3, PRT_F4, PRT_F5, PRT_F6;
	{
		try {
	...
	private HashMap<String, GFXChat> hashCuts = new HashMap<>();
	{
		...
		temp.add("Christopher Belmont",
				"It is for that one same blood that my whip shall seek revenge against thee, dark lord.", PRT_CHRIS);
		temp.add("Count Dracula",
		...
		temp.add("???", "Leave this castle now if you want to live... this is not a place for commoners like you",
				PRT_CLAW);
		...
		temp.add("Count Dracula",
				...
				PRT_DRACULA);
		temp.add("Count Dracula",
				"Can you not see that you are not the heir of the night hunters? They are mine, already!", PRT_DRACULA);
		temp.add("%NAME",
		...
		temp = new GFXChat();
		temp.add("Short haired girl", "What a nasty surprise... another annoying bug comes to stop our advancement",
				PRT_CLARA);
