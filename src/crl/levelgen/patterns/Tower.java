...
public class Tower extends StaticPattern {
	...
	public Tower() {
		...
		spawnInfo = new MonsterSpawnInfo[] { new MonsterSpawnInfo("MEDUSA_HEAD", MonsterSpawnInfo.BORDER, 50) };
	}
	...
	public MonsterSpawnInfo[] getDwellers() {
		return new MonsterSpawnInfo[] { new MonsterSpawnInfo("CROW", MonsterSpawnInfo.UNDERGROUND, 90),
