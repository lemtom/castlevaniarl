...
public class BatLair {
	...
	// public static final Position playerPosition = new Position(1,15);
	public static final Position start = new Position(0, 15);
	public static final Position end = new Position(73, 15);

	public static final String boss = "GIANTBAT";
	public static final Position bossPosition = new Position(60, 15);
