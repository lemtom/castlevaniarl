...
public class BigTown extends StaticPattern {
	...
	public BigTown() {
		cellMap = new String[][] { { "______________________________________________________________________", //
		...
		spawnInfo = new MonsterSpawnInfo[] { new MonsterSpawnInfo("GZOMBIE", MonsterSpawnInfo.UNDERGROUND, 95),
