...
public class CastleBridge extends StaticPattern {
	...
	public CastleBridge() {
		...
		spawnInfo = new MonsterSpawnInfo[] { new MonsterSpawnInfo("MERMAN", MonsterSpawnInfo.WATER, 85) };
	}

	@Override
	public MonsterSpawnInfo[] getDwellers() {
		return new MonsterSpawnInfo[] { new MonsterSpawnInfo("R_SKELETON", MonsterSpawnInfo.UNDERGROUND, 80),
