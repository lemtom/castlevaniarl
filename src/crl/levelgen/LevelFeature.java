...
public class LevelFeature {
	...
	public static final String[] descriptions = new String[] { "COURTYARDGRASS", "COURTYARDDIRT", "BRICKWALKWAY",
			"COURTYARDDOOR", "COURTYARDWALL", "CASTLEWALL", "GARGOYLESTATUE", "HUMANSTATUE", "DARKTREE", "DEADSTUMP",
			"TORCH", "FENCE", "CASTLEDOOR", "FOUNTAINCENTER", "FOUNTAINAROUND", "FOUNTAINPOOL", "STREAM" };
