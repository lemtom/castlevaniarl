...
public class TargetPS extends ProjectileSkill {
	...
	public boolean canPerform(Actor a) {
		...
		if (!EffectFactory.getSingleton().isDirectedEffect("SFX_WP_" + weapon.getDefinition().getID())) {
			invalidationMessage = "You cannot target your " + weapon.getDescription()
					+ ". Attack on a direction instead!";
			return false;
		}
